...
5. `execution/PROJECT-MANAGEMENT-BROWNFIELD-EXECUTION-PROMPTS.md`
6. `openspec/changes/project-management/`
7. `execution/BROWNFIELD-FEATURE-ACCEPTANCE-MATRIX.md`
8. `execution/BROWNFIELD-DELIVERY-TEMPLATE.md`
...
6. `execution/PROJECT-MANAGEMENT-BROWNFIELD-EXECUTION-PROMPTS.md`
...
3. 如果判定为 `M-Medium`，走最小探索 + 最小 OpenSpec + 快速审批，并参考 `execution/M-MEDIUM-MINIMAL-OPENSPEC-EXAMPLE.md`
4. 如果判定为 `L / High Risk`，看 `execution/PROJECT-MANAGEMENT-BROWNFIELD-EXECUTION-PROMPTS.md`
...
3. `execution/M-MEDIUM-MINIMAL-OPENSPEC-EXAMPLE.md`
...
3. `execution/BROWNFIELD-DELIVERY-TEMPLATE.md`
...
4. `execution/BROWNFIELD-DELIVERY-TEMPLATE.md`
...
1. `core/AI-ADOPTION-GOVERNANCE-HANDBOOK.md`
2. `execution/PROJECT-MANAGEMENT-BROWNFIELD-EXECUTION-PROMPTS.md`
3. `execution/PROJECT-MANAGEMENT-BROWNFIELD-PRACTICAL-CASE.md`
...
6. `execution/AI-WORKFLOW-TOOLING-PREREQUISITES.md`
7. `execution/BROWNFIELD-RULE-BASELINE-PLAYBOOK.md`
8. `execution/BROWNFIELD-AI-PROMPT-HANDBOOK.md`
...
1. 先看 `core/AI-ADOPTION-GOVERNANCE-HANDBOOK.md` 判断路径
2. 按 `execution/BROWNFIELD-RULE-BASELINE-PLAYBOOK.md` 巡查项目
3. 用 `execution/BROWNFIELD-AI-PROMPT-HANDBOOK.md` 和 rules 提炼统一约束
4. 按分流进入对应资料
5. 用 `execution/PROJECT-MANAGEMENT-BROWNFIELD-PRACTICAL-CASE.md` 与 `openspec/changes/project-management/` 校准规格和提示词写法
