...
> 目标：作为这套资料的“全量资产清单”，说明当前有哪些正式文档、分别属于哪一层、哪些属于历史资料。  
> 使用原则：这份文档负责“全景盘点”，不负责替代流程入口；如果你想知道现在该从哪里开始，请转到 `core/BROWNFIELD-AI-DEVELOPMENT-INDEX.md`。  
> 使用边界：这份文档用于盘点资产和做阅读规划，不建议拿它代替日常需求执行入口。

## 推荐连读

如果你想先看全景，再进入执行，建议按这个顺序：

1. `core/BROWNFIELD-AI-DEVELOPMENT-INDEX.md`
2. `core/AI-ADOPTION-GOVERNANCE-HANDBOOK.md`
3. `core/PROJECT-MANAGEMENT-DOC-MAP.md`
4. `execution/AI-WORKFLOW-TOOLING-PREREQUISITES.md`
5. `review/EXPERT-REVIEW-PACK-LIST.md`
...
2. `core/TEAM-ADOPTION-QUICKSTART.md`
...
6. `execution/BROWNFIELD-QUICKSTART-CHECKLIST.md`
   定位：最小执行清单。

7. `execution/PROJECT-MANAGEMENT-BROWNFIELD-PRACTICAL-CASE.md`
   定位：高风险完整流程主案例。

8. `execution/M-MEDIUM-MINIMAL-OPENSPEC-EXAMPLE.md`
   定位：`M-Medium` 最小 OpenSpec 示例。

9. `execution/BROWNFIELD-FEATURE-ACCEPTANCE-MATRIX.md`
   定位：验收矩阵模板与示例。

10. `execution/BROWNFIELD-DELIVERY-TEMPLATE.md`
    定位：统一交付模板。
...
1. `review/EXPERT-REVIEW-PACK-LIST.md`
   定位：专家评审包清单。
...
4. `review/AI-ADOPTION-FINAL-CONCLUSION-MINUTES.md`
