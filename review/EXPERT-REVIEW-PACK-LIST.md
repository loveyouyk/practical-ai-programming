...
1. `knowledge/core/AI-ADOPTION-DOCUMENT-CATALOG.md`：看当前全量资料分层；
2. `knowledge/core/AI-ADOPTION-GOVERNANCE-HANDBOOK.md`：看治理总口径；
3. `knowledge/review/AI-ADOPTION-FINAL-CONCLUSION-MINUTES.md`：看最终结论和采纳边界；
4. `knowledge/core/BROWNFIELD-AI-DEVELOPMENT-INDEX.md`：看团队内部默认入口。
...
11. `knowledge/execution/BROWNFIELD-DELIVERY-TEMPLATE.md`
    作用：统一交付模板。
    建议重点评审：
    - 是否能支撑交付沉淀
...
12. `knowledge/execution/M-MEDIUM-MINIMAL-OPENSPEC-EXAMPLE.md`
...
2. `knowledge/execution/BROWNFIELD-CHANGE-UPDATE-WORKFLOW.md`
   作用：开发中发现需求遗漏时的回写流程。
   建议重点评审：
   - 需求变更处理是否严谨
...
4. `knowledge/history/AI-ADOPTION-DISCUSSION-PROPOSAL.md`
   作用：治理方案历史讨论稿。
   使用边界：
...
1. `knowledge/execution/BROWNFIELD-RULE-BASELINE-PLAYBOOK.md`
...
5. `knowledge/execution/M-MEDIUM-MINIMAL-OPENSPEC-EXAMPLE.md`
...
3. `knowledge/execution/BROWNFIELD-CHANGE-UPDATE-WORKFLOW.md`
4. `knowledge/execution/BROWNFIELD-QUICKSTART-CHECKLIST.md`
5. `knowledge/core/AI-ADOPTION-GOVERNANCE-HANDBOOK.md`
...
1. 总入口：
   `knowledge/core/BROWNFIELD-AI-DEVELOPMENT-INDEX.md`
2. 治理总手册：
...
6. 验收与交付：
   ...
   `knowledge/execution/BROWNFIELD-CHANGE-UPDATE-WORKFLOW.md`
7. 结论纪要：
